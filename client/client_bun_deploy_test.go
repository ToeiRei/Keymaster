...
func (f *fakeDM) DecommissionAccount(account model.Account, systemPrivateKey core.Secret, options interface{}) (core.DecommissionResult, error) {
    return core.DecommissionResult{Account: account, AccountID: account.ID}, nil
}
func (f *fakeDM) BulkDecommissionAccounts(accounts []model.Account, systemPrivateKey core.Secret, options interface{}) ([]core.DecommissionResult, error) {
