...
func New(c client.Client) *Model {
	...
	menuPtr := util.ModelPointer(menu.New(
		...
		menu.WithItem("publickey.list", i18n.Text("menu.public_keys")),
		menu.WithItem("account.list", i18n.Text("menu.accounts")),
		menu.WithItem("auditlog.list", i18n.Text("menu.auditlog")),
		menu.WithItem("", i18n.Text("menu.deploy"),
			menu.WithItem("deploy.dirty", i18n.Text("menu.deploy_dirty")),
			menu.WithItem("deploy.all", i18n.Text("menu.deploy_all")),
			menu.WithItem("deploy.verify", i18n.Text("menu.verify_all")),
		),
